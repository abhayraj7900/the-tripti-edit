...
- FAQ, shipping, and returns information within the Contact page

## Payments and checkout

- UPI or payment link
- Cash on delivery
- Checkout collects the customer’s name, phone number, and address
- Order is sent to the store through a pre-filled WhatsApp message

## Customer contact

- WhatsApp is the primary contact channel
- Contact form opens a pre-filled WhatsApp conversation
